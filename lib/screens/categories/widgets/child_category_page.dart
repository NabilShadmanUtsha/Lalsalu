...
class ChildCategoryPage extends StatefulWidget {
  ...
  final ChildCategories subCategories;
  ...
  @override
  State<ChildCategoryPage> createState() => _MainCategoriesState();
}

class _MainCategoriesState extends State<ChildCategoryPage> {
